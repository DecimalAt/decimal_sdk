...
export interface JobManagerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "whitelistEnclaveImage",
    values: [AttestationAuther.EnclaveImageStruct],
  ): string;
  encodeFunctionData(
    functionFragment: "whitelistEnclaveKey",
...
export interface JobManager extends BaseContract {
  ...
  createJob: TypedContractMethod<
    [
      ...
      _input: BytesLike,
      _paymentPerSecond: BigNumberish,
  ...
  isEnclaveKeyValid: TypedContractMethod<[key: AddressLike], [void], "view">;
  ...
  whitelistEnclaveImage: TypedContractMethod<
    [image: AttestationAuther.EnclaveImageStruct],
    [void],
    "nonpayable"
  >;

  whitelistEnclaveKey: TypedContractMethod<
    [enclavePubKey: BytesLike, imageId: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[key: AddressLike], [void], "view">;
  getFunction(
